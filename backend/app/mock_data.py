...
# ---------------------------------------------------------------------------
# Additional demo dataset
# This seed is intentionally ADDITIVE and idempotent. It runs even when the
# database already contains the original seed data, so deployed environments
# do not need shell access or a database reset.
# ---------------------------------------------------------------------------

ADDITIONAL_DEMO_PROTOCOLS = [
    {
        "name": "AYU-DM-TEST-01",
        "condition": "Type 2 Diabetes",
        "text": """AYU-DM-TEST-01: Ayurveda Supportive Care in Type 2 Diabetes
Inclusion: age 40 to 65 years; confirmed Type 2 Diabetes; HbA1c 7.0% to 9.0%;
BMI 27 to 35 kg/m^2; eGFR >= 45 mL/min/1.73m^2.
Exclusion: eGFR below 45; pregnancy or breastfeeding; active serious infection.
Synthetic demonstration protocol only. Not for clinical use.""",
        "criteria": [
            {"criterion_id":"age","type":"inclusion","field":"age","label":"Age","operator":"between","value":[40,65],"unit":"years","source_text":"Age 40 to 65 years.","verification_required":False},
            {"criterion_id":"condition","type":"inclusion","field":"condition","label":"Diagnosis","operator":"equals","value":"Type 2 Diabetes","unit":"","source_text":"Confirmed Type 2 Diabetes.","verification_required":False},
            {"criterion_id":"hba1c","type":"inclusion","field":"HbA1c","label":"HbA1c","operator":"between","value":[7.0,9.0],"unit":"%","source_text":"HbA1c 7.0% to 9.0%.","verification_required":False},
            {"criterion_id":"bmi","type":"inclusion","field":"BMI","label":"BMI","operator":"between","value":[27,35],"unit":"kg/m^2","source_text":"BMI 27 to 35 kg/m^2.","verification_required":False},
            {"criterion_id":"egfr","type":"inclusion","field":"eGFR","label":"Renal function","operator":"gte","value":45,"unit":"mL/min/1.73m^2","source_text":"eGFR >= 45.","verification_required":False},
        ],
    },
    {
        "name": "AYU-LIPID-TEST-02",
        "condition": "Hyperlipidemia",
        "text": """AYU-LIPID-TEST-02: Ayurveda Supportive Care in Hyperlipidemia
Inclusion: age 40 to 70 years; confirmed Hyperlipidemia; LDL 130 to 190 mg/dL;
triglycerides <= 400 mg/dL; BMI 18.5 to 35 kg/m^2; eGFR >= 45.
Exclusion: eGFR below 45; known hypersensitivity to study intervention.
Synthetic demonstration protocol only. Not for clinical use.""",
        "criteria": [
            {"criterion_id":"age","type":"inclusion","field":"age","label":"Age","operator":"between","value":[40,70],"unit":"years","source_text":"Age 40 to 70 years.","verification_required":False},
            {"criterion_id":"condition","type":"inclusion","field":"condition","label":"Diagnosis","operator":"equals","value":"Hyperlipidemia","unit":"","source_text":"Confirmed Hyperlipidemia.","verification_required":False},
            {"criterion_id":"ldl","type":"inclusion","field":"LDL","label":"LDL cholesterol","operator":"between","value":[130,190],"unit":"mg/dL","source_text":"LDL 130 to 190 mg/dL.","verification_required":False},
            {"criterion_id":"tg","type":"inclusion","field":"Triglycerides","label":"Triglycerides","operator":"lte","value":400,"unit":"mg/dL","source_text":"Triglycerides <= 400 mg/dL.","verification_required":False},
            {"criterion_id":"bmi","type":"inclusion","field":"BMI","label":"BMI","operator":"between","value":[18.5,35],"unit":"kg/m^2","source_text":"BMI 18.5 to 35 kg/m^2.","verification_required":False},
            {"criterion_id":"egfr","type":"inclusion","field":"eGFR","label":"Renal function","operator":"gte","value":45,"unit":"mL/min/1.73m^2","source_text":"eGFR >= 45.","verification_required":False},
        ],
    },
    {
        "name": "AYU-HTN-TEST-03",
        "condition": "Hypertension",
        "text": """AYU-HTN-TEST-03: Integrative Management of Hypertension
Inclusion: age 35 to 70 years; confirmed Hypertension; systolic BP 130 to 160 mmHg;
diastolic BP 80 to 100 mmHg; BMI 20 to 35 kg/m^2; eGFR >= 45.
Exclusion: severe renal impairment; pregnancy.
Synthetic demonstration protocol only. Not for clinical use.""",
        "criteria": [
            {"criterion_id":"age","type":"inclusion","field":"age","label":"Age","operator":"between","value":[35,70],"unit":"years","source_text":"Age 35 to 70 years.","verification_required":False},
            {"criterion_id":"condition","type":"inclusion","field":"condition","label":"Diagnosis","operator":"equals","value":"Hypertension","unit":"","source_text":"Confirmed Hypertension.","verification_required":False},
            {"criterion_id":"sbp","type":"inclusion","field":"SBP","label":"Systolic blood pressure","operator":"between","value":[130,160],"unit":"mmHg","source_text":"Systolic BP 130 to 160 mmHg.","verification_required":False},
            {"criterion_id":"dbp","type":"inclusion","field":"DBP","label":"Diastolic blood pressure","operator":"between","value":[80,100],"unit":"mmHg","source_text":"Diastolic BP 80 to 100 mmHg.","verification_required":False},
            {"criterion_id":"bmi","type":"inclusion","field":"BMI","label":"BMI","operator":"between","value":[20,35],"unit":"kg/m^2","source_text":"BMI 20 to 35 kg/m^2.","verification_required":False},
            {"criterion_id":"egfr","type":"inclusion","field":"eGFR","label":"Renal function","operator":"gte","value":45,"unit":"mL/min/1.73m^2","source_text":"eGFR >= 45.","verification_required":False},
        ],
    },
    {
        ...
        "text": """AYU-RA-TEST-04: Integrative Care in Rheumatoid Arthritis
Inclusion: age 18 to 70 years; confirmed Rheumatoid Arthritis; CRP >= 10 mg/L;
BMI 18 to 35 kg/m^2; eGFR >= 45.
Exclusion: active infection; prior serious hypersensitivity to intervention.
Synthetic demonstration protocol only. Not for clinical use.""",
        "criteria": [
            {"criterion_id":"age","type":"inclusion","field":"age","label":"Age","operator":"between","value":[18,70],"unit":"years","source_text":"Age 18 to 70 years.","verification_required":False},
            {"criterion_id":"condition","type":"inclusion","field":"condition","label":"Diagnosis","operator":"equals","value":"Rheumatoid Arthritis","unit":"","source_text":"Confirmed Rheumatoid Arthritis.","verification_required":False},
            {"criterion_id":"crp","type":"inclusion","field":"CRP","label":"CRP","operator":"gte","value":10,"unit":"mg/L","source_text":"CRP >= 10 mg/L.","verification_required":False},
            {"criterion_id":"bmi","type":"inclusion","field":"BMI","label":"BMI","operator":"between","value":[18,35],"unit":"kg/m^2","source_text":"BMI 18 to 35 kg/m^2.","verification_required":False},
            {"criterion_id":"egfr","type":"inclusion","field":"eGFR","label":"Renal function","operator":"gte","value":45,"unit":"mL/min/1.73m^2","source_text":"eGFR >= 45.","verification_required":False},
        ],
    },
    {
        ...
        "text": """AYU-HV-TEST-05: Healthy Volunteer Safety Observation Protocol
Inclusion: age 18 to 45 years; healthy volunteer status; BMI 18.5 to 29.9 kg/m^2;
HbA1c 4.5% to 5.9%; eGFR >= 60; ALT <= 40 U/L.
Exclusion: clinically significant illness requiring treatment.
Synthetic demonstration protocol only. Not for clinical use.""",
        "criteria": [
            {"criterion_id":"age","type":"inclusion","field":"age","label":"Age","operator":"between","value":[18,45],"unit":"years","source_text":"Age 18 to 45 years.","verification_required":False},
            {"criterion_id":"condition","type":"inclusion","field":"condition","label":"Healthy volunteer status","operator":"equals","value":"Healthy Volunteer","unit":"","source_text":"Healthy volunteer status.","verification_required":False},
            {"criterion_id":"bmi","type":"inclusion","field":"BMI","label":"BMI","operator":"between","value":[18.5,29.9],"unit":"kg/m^2","source_text":"BMI 18.5 to 29.9 kg/m^2.","verification_required":False},
            {"criterion_id":"hba1c","type":"inclusion","field":"HbA1c","label":"HbA1c","operator":"between","value":[4.5,5.9],"unit":"%","source_text":"HbA1c 4.5% to 5.9%.","verification_required":False},
            {"criterion_id":"egfr","type":"inclusion","field":"eGFR","label":"Renal function","operator":"gte","value":60,"unit":"mL/min/1.73m^2","source_text":"eGFR >= 60.","verification_required":False},
            {"criterion_id":"alt","type":"inclusion","field":"ALT","label":"ALT","operator":"lte","value":40,"unit":"U/L","source_text":"ALT <= 40 U/L.","verification_required":False},
        ],
    },
]

def seed_additional_demo_data(db):
    """Add the five requested demo patients/protocols without resetting data."""
    patients = [
        Patient(name="Nisha Rao", age=52, condition="Type 2 Diabetes",
                biomarkers="HbA1c:7.8,BMI:29,eGFR:82,LDL:142,SBP:138,DBP:86", location="Hyderabad, India"),
        Patient(name="Arjun Mehta", age=44, condition="Hyperlipidemia",
                biomarkers="LDL:168,BMI:26,eGFR:78,Triglycerides:220,SBP:132,DBP:84", location="Bengaluru, India"),
        Patient(name="Kavya Reddy", age=63, condition="Hypertension",
                biomarkers="LDL:128,BMI:31,eGFR:58,SBP:148,DBP:92,HbA1c:6.4", location="Vijayawada, India"),
        Patient(name="Rohan Iyer", age=35, condition="Rheumatoid Arthritis",
                biomarkers="CRP:18.5,RF:positive,BMI:24,eGFR:91,SBP:126,DBP:80", location="Chennai, India"),
        Patient(name="Meera Kapoor", age=28, condition="Healthy Volunteer",
                biomarkers="BMI:22.4,eGFR:105,SBP:112,DBP:72,HbA1c:5.2,ALT:21", location="Mumbai, India"),
    ]
    added_patients = 0
    for patient in patients:
        if not db.query(Patient).filter(Patient.name == patient.name).first():
            db.add(patient)
            added_patients += 1
    db.commit()

    added_trials = 0
    for spec in ADDITIONAL_DEMO_PROTOCOLS:
        trial = db.query(Trial).filter(Trial.name == spec["name"]).first()
        if trial:
            continue
        trial = Trial(
            name=spec["name"],
            ...
            criteria=spec["text"],
            structured_criteria=json.dumps(spec["criteria"]),
        )
        db.add(trial)
        db.commit()
        db.refresh(trial)
        for i, chunk in enumerate(chunk_text(spec["text"], chunk_size=80, overlap=15)):
            db.add(ProtocolChunk(trial_id=trial.id, chunk_index=i, content=chunk))
        db.commit()
        added_trials += 1

    if added_patients or added_trials:
        print(f"Additional demo seed: added {added_patients} patient(s), {added_trials} protocol(s).")
